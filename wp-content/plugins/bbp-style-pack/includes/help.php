...
</p><p><?php _e('I use Color Cop see <a href = "http://colorcop.net/screenshots/" target="_blank"> http://colorcop.net/screenshots/</a>', 'bbp-style-pack'); ?>
...
<h4><span style="color:blue"><?php _e('If you need further help', 'bbp-style-pack' ) ; ?></span></h4>
<p>
