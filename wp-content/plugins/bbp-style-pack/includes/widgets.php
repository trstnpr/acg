...
class bsp_Activity_Widget extends WP_Widget {
	...
	public function update( $new_instance = array(), $old_instance = array() ) {
		...
		//check that parent_forum only contains numbers or numbers seperated by commas
		$re = '/^\d+(?:,\d+)*$/';
	...
	public function form( $instance = array() ) {
		...
		<p>
			...
			<small><?php _e( 'See dashboard>forums>all forums to find the ID of a forum', 'bbp-style-pack' ); ?></small>
