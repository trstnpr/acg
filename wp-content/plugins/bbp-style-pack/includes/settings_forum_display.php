...
<!--add forum description to forum lists------------------------------------------------------------------->
		<tr>
			...
			<td width="16%">
				...
				echo '<input name="'.$item.'" id="'.$item.'" type="checkbox" value="1" class="code" ' . checked( 1,$item1, false ) . ' /> Add Forum List Description';
				?>
			</td>
...
<!--Remove Forum Description ------------------------------------------------------------------->
		<tr>
			...
			<td width="16%">
				...
				echo '<input name="'.$item.'" id="'.$item.'" type="checkbox" value="1" class="code" ' . checked( 1,$item1, false ) . ' /> Remove Forum Description';
				?>
			</td>
...
<!--Add thumbnails to forum lists ------------------------------------------------------------------->
		<tr>
			...
			<td width="16%">
				...
				echo '<input name="'.$item.'" id="'.$item.'" type="checkbox" value="1" class="code" ' . checked( 1,$item1, false ) . ' /> Add Thumbnail Picture';
				?>
			</td>
