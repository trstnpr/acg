	...
	<table class="form-table">
		<tr valign="top">
			<th colspan="2">
					...
					<p>
						<?php _e ('This tab lets you decide what roles will be displayed, where they are displayed, what names they are called, and how they are styled', 'bbp-user-ranking' ) ; ?>
					</p>
					<p>
						<?php _e ('For instance you may not want to display roles at all, or only display moderator.  You might also want to change "keymaster" to say "Admin"' , 'bbp-user-ranking' ) ; ?>
					</p>
			</th>
		</tr>
	</table>
	...
	<table>
		...
		<?php
			...
			<td style="width : 200px">
				...
				<p>
				<?php _e ('By default bbpress puts a line between the display name and the role. You can opt to remove this selecting', 'bbp-user-ranking' ) ; ?>
				</p>
			</td> 
			<td style="width : 200px">
		...
		<tr>
			...
			<td style="vertical-align:top">
				...
				<?php if ($name == 'bbp_keymaster') { ?>
					<br/>
					<label class="description">
						<?php _e( '<br/>Click to select the font color if required', 'bbp-style-pack' ); ?>
					</label>
				<?php }
				else { ?>
					<br/>
					<label class="description">
					<?php _e( '<br/>Font color', 'bbp-style-pack' ); ?>
					</label>
				<?php } ?>
			</td>
			...
			<td style="vertical-align:top">
				...
				<?php if ($name == 'bbp_keymaster') { ?>
					<label class="description"><?php _e( 'Enter the font size - Default 12px', 'bbp-style-pack' ); ?>
					</label>
				<?php }
				else { ?>
					<br/>
		...
		<tr>
			...
			<td style="vertical-align:top">
				...
				<?php if ($name == 'bbp_keymaster') { ?>
					<br/>
					<label class="description">
						<?php _e( '<br/>Click to select the background color if required', 'bbp-style-pack' ); ?>
					</label>
				<?php }
				else { ?>
					<br/>
					<label class="description">
						<?php _e( '<br/>Background color', 'bbp-style-pack' ); ?>
					</label>
				<?php } ?>
			</td>
